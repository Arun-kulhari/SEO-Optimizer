...
SERPAPI_KEY = "578381ea590aa762b3c0cb8c3babf3ce88b5e44bc8c2c897fb0aaff9e9cf4278"
...
def gradio_interface():
    with gr.Blocks(title="Keyword Trend Analyzer") as demo:
        ...
        *💡 Tip:* Start with basic analysis, then use the buttons below for detailed data that requires API calls.
        ...
        with gr.Row():
            semrush_detailed_df = gr.Dataframe(label="📊 SEMrush Detailed Data (Volume, CPC, Competition)", interactive=True)
